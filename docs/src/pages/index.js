...
export default function Home() {
  ...
  return (
    <Layout title="IqbalAPI" description="A free, open REST API for Allama Iqbal's poetry.">
      <div className={styles.page}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroInner}>
            ...
            <div className={styles.ctas}>
              ...
              <a className={styles.btnOutline} href="https://iqbal-api.up.railway.app" target="_blank" rel="noopener noreferrer">Live API ↗</a>
              <a className={styles.btnGhost} href="https://github.com/TheMirza009/iqbal-api" target="_blank" rel="noopener noreferrer">GitHub ↗</a>
            </div>
          </div>
        </section>
        ...
        <section className={`${styles.section} ${styles.sectionIndented}`}>
          <div className={styles.container}>
            ...
            <h2 className={styles.sectionTitle}>Four Books of Iqbal's Poetry</h2>
        ...
        <section className={`${styles.section} ${styles.sectionAlt}`}>
          <div className={styles.container}>
            ...
            <h2 className={styles.sectionTitle}>Simple, Predictable Endpoints</h2>
            <div className={styles.endpointList}>
              {ENDPOINTS.map((e, i) => (
                <a key={i} className={styles.endpointRow} href={`https://iqbal-api.up.railway.app${e.path}`} target="_blank" rel="noopener noreferrer">
